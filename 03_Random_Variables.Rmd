...
$$\begin{aligned} G(y)  
  ...
  &= Pr\left( X \ge \frac{y}{60} \right) \\
  &= F\left( \frac{y}{60} \right) \\
  &= 1 - e^{6(\frac{y}{60})} \\
  &= 1-e^{y/10} \end{aligned}$$ 
...
Furthermore, Suppose that I want the pdf of $Y$ and not the CDF.

$$Plan:\;\;\; f(x) \stackrel{Integrate}{\Longrightarrow} F(x) = Pr(X\le x)\stackrel{CDF\; Method}{\Longrightarrow}
