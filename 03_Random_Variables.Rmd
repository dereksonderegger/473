...
4. **Geometric Distribution** Suppose that we flip a biased coin that has probability of heads as $p \in [0,1]$. Let the r.v. $X$ be the number of coint flips until the first head is observed.
...
$$ F(x) = \begin{cases} 
  ...
  1                 & \textrm{ for } x > 3 
  \end{cases}$$
    a) Find and the pdf function $f(x)$.
...
$$F^{-1}(p) = \min(x) \textrm{ such that } F(x) \le p$$
