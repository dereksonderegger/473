...
2. Suppose we have a discrete joint distribution with probability function
$$f(x,y)=$$

Suppose that $X$ and $Y$ have a discrete joint distribution for which the joint p.f. is defined as follows:
$$f(x,y) = \begin{cases}
...
Unsurprisingly, the requirements for a functio $f(x,y$ to be a joint pdf are:
* $f(x,y) \ge 0$ for all $(x,y)$ in $\mathbb{R}^2$ 
