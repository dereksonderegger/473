...
**pdf method**
Just as in the univariate case, we might ask if there is a way to just go straight from the joint pdf to the pdf of the variable of interest.  The answer is yes provided, 
